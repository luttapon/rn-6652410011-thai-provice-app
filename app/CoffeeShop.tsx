  ...
  const fetchCoffeeShops = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from('locations')
        .select('*')
        .eq('category', 'cafe'); // ดึงเฉพาะหมวดร้านกาแฟ
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>ร้านกาแฟแนะนำ</Text>
        <View style={{ width: 28 }} />
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.emptyText}>ไม่พบข้อมูลร้านกาแฟ</Text>}
      />
    </View>
  );
};
